...
class DataImport(object):
    ...
    def __init__(self, path: str = r'C:\Users\mauro\OneDrive\AE Bachelor - TU Delft\Year 3\DSE - Local\DAPOS_Main\src\atmos_model\nlrmsise-00_data\AP'):
        self.__yearlst = [f for f in listdir(path) if isfile(join(path, f))]
        self.__pathlst = self.__yearlst
    ...
    def __apdaily(self):
        ...
        self.__apdata.append([self.__yearlst[idx1],apdata])
